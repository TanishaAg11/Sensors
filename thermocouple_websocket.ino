...
int csPin = 41;// CS = chip select CS pin
int sckPin = 40;// SCK = Serial Clock pin
...
void loop() {
  ...
  {
    String c = String(float(robojax.readCelsius()));
    String f = String(float(robojax.readFahrenheit()));
    p_time = c_time;
    ws.textAll("C = ");
    ws.textAll(c);
    ws.textAll(" F = ");
